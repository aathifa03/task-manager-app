      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white transition-colors duration-300">
        ...
        <main className="px-3 py-4 sm:py-5 sm:px-6 relative overflow-hidden">
          <section className="mx-auto max-w-7xl px-0 sm:px-2 lg:px-4">
            ...
            <div className="space-y-2.5 rounded-xl border border-blue-200 dark:border-blue-500/20 bg-white dark:bg-slate-900/90 p-3.5 shadow-sm mb-4">
              <div className="flex flex-col sm:flex-row gap-2.5">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-950/60 pl-8 pr-3 py-2 text-xs text-slate-900 dark:text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  />
                </div>
